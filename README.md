...
1. Отключаем VPN, если включен (так не понадобится номер телефона)
2. В настройках телефона заходим в пункт "Аккаунты"
...
5. Нажимаем "Создать аккаунт" -> "Для личного пользования"
...
4. **Для SMS:**
   - Качаем [макрос для SMS](https://raw.githubusercontent.com/jellybebra/bank-notifications-spreadsheet/refs/heads/main/sms_spreadsheet.macro)
